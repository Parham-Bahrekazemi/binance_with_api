...
import 'package:binance/ui/ui_helper/shimmer_market_view.dart';
...
class _MarketViewPageState extends State<MarketViewPage> {
  ...
  late final MarketViewProvider marketProvider;
  @override
  void initState() {
    super.initState();

    marketProvider = Provider.of<MarketViewProvider>(context, listen: false);
